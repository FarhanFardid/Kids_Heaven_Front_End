...
const Slider = () => {
    return (
        <div className="carousel w-full md:h-[650px] max-h-fit">
        <div id="slide1" className="carousel-item relative w-full h-full  ">
          ...
          <div className="absolute h-full flex items-center  left-0 top-0  rounded-xl bg-gradient-to-r from-[#2e284f] to-[rgba(20, 20, 20, 0)]">
            <div className='text-white space-y-7 md:pl-12 md:w-2/3 md:h-full md:pt-44  '>
        ...
        <div id="slide2" className="carousel-item relative w-full h-full  ">
          ...
          <div className="absolute h-full flex items-center  left-0 top-0  rounded-xl bg-gradient-to-r from-[#2e284f] to-[rgba(20, 20, 20, 0)]">
            <div className='text-white space-y-7 pl-12 w-2/3 h-full pt-44  '>
            <h2 className='text-5xl text-red-600 p-2 font-bold'>Bringing the Animal Kingdom to Your Doorstep...</h2>
                <p className='p-2 text-xl'>Let The Imagination Run Wild with Our Amazing Animal Toy Collection. Discover a Heaven of Animals.</p>
                <div>   <button className="btn bg-red-700 mx-3">Explore Kids Heaven</button>
               </div>
