...
const AboutUs = () => {
    return (
       ...
       <div className='absolute md:top-[60%] top-[55%] md:w-3/6 w-2/3 md:left-[360px] md:px-2 left-[80px] px-5 pt-2  text-red-950 text-center'><h5 className='md:text-2xl text-sm font-bold text-center md:py-3 py-1'>Connecting Children with the Wonders of the Animal World</h5>
